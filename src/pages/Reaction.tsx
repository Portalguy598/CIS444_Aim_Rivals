...
export default function ReactionGame()
{
	...
	return (
		<div className='container font-roboto'>
			...
			<div className='gameContainerReact' onClick={() => onGameClick()}>
				...
				{(gameLogic.uiGameState === GameState.COMPLETE) && (
					<div className='gameOverlayReact' onClick={doGameReset}>
						<h1 className='gameOverTitle'>Game over!</h1>
						<h3 className='gameOverScore'>You scored {gameLogic.uiScore} points</h3>
						<h3 className='gameOverAccuracy'>You had {(gameLogic.uiClicks > 
							0 ? 100 * gameLogic.uiHits / gameLogic.uiClicks : 0).toFixed(2)}% accuracy</h3>
